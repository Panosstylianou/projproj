...
class CrossfadeStoryboard: NSStoryboardSegue {
    ...
    override func perform() {
        ...
        //perform transition
        containerViewController.transitionFromViewController(sourceViewController, toViewController: destinationViewController, options: NSViewControllerTransitionOptions.None, completionHandler: nil)
